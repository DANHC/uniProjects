...
public class CalendarioController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<ProgramacionPartido> programaciones;
        ProgramacionPartidoDAO progDao = new ProgramacionPartidoDAO();
        
        Torneo tor = (Torneo) request.getServletContext().getAttribute("torneo");
        
        programaciones = progDao.getPartidosProgramados(tor.getId());
        
        request.setAttribute("programaciones", programaciones);
        request.getRequestDispatcher("paginas/calendarioPartidos.jsp").forward(request, response);
